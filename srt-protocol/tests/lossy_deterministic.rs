...
fn lossy_deterministic() {
    ...
    let once_failing_seeds = [
        (3330590297113083014, 1_000),
        (11174431011217123256, 1_000),
        (7843866891970470107, 1_000),
        (940980453060602806, 1_000),
        (10550053401338237831, 1_000),
        (9602806002654919948, 1_000),
        (11134687271549837280, 1_000),
        (10210281456068034833, 1_000),
    ];

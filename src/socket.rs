...
use crate::tokio::sender::SenderStream;
...
pub struct SrtSocket {
    ...
    sender: SenderStream<PackChan, SrtCongestCtrl>,
        ...
        + 'static,
{
    ...
    SrtSocket {
        ...
        sender: SenderStream::new(sender_chan, SrtCongestCtrl, conn.settings, conn.handshake),
